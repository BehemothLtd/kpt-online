<template>
  <b-input-group class="mb-4">
    <b-input-group-append>
      <b-button variant="outline-primary" @click="exportPdfWithImage()">Export PDF With Image</b-button>
      <b-button variant="outline-primary" @click="exportPdfWithHtml()">Export PDF With Html</b-button>
    </b-input-group-append>
  </b-input-group>
</template>
